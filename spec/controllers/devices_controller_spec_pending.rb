...
describe DevicesController do
  ...
  #       post :create, {:device => { "user_id" => "invalid value" }}, valid_session
  #       assigns(:device).should be_a_new(Device)
  #     end
  ...
  #       Device.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
  #       put :update, {:id => device.to_param, :device => { "user_id" => "1" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Device.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => device.to_param, :device => { "user_id" => "invalid value" }}, valid_session
  #       assigns(:device).should eq(device)
  #     end
